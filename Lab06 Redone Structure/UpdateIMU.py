...
class UpdateIMU:
    ...
    def __init__(self, s_field_heading: Share, i2c):
        ...
        Args:
            s_field_heading: task_share.Share object used to convey the romi chassis heading in field-space accorning to the IMU.
            i2c: machine.I2C object, preinitialized, to designate the correct communication bus.
        """
